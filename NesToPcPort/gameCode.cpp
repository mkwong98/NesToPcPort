...
L_000308:
    ...
    pushAddress(0x832C);
    jump(0xFE95);
    if (handleReturnAddress(poppedEntry.value, 0x832C)) return;
    a = myMapper->readCPU(0x0010);
    myMapper->writeCPU(0xBFFF, a);
    opLSR_A(1);
    myMapper->writeCPU(0xBFFF, a);
...
void game::SUB_0003CF() {
    ...
    opORA(0x04);
    myMapper->writeCPU(0x0043, a);
    a = myMapper->readCPU(0x0583);
    opPHA();
    a = myMapper->readCPU(0x0584);
    opPHA();
    myMapper->writeCPU(0x0584, 0x00);
...
L_00073B:
    ...
    opCMP(y, myMapper->readCPU(0x0584));
    if (!flgZ) {
        if (flgC) {
            goto L_000750;
        }
        ...
        if (x < myMapper->readCPU(0x0583)) {
            goto L_000756;
        }
    L_000750:
        myMapper->writeCPU(0x0583, x);
...
void game::SUB_0017FC() {
    ...
    myMapper->writeCPU(0x0385 + x, myMapper->readCPU(0x0583));
    a = myMapper->readCPU(0x0584);
    flgC = false;
    opADC(0x01);
    myMapper->writeCPU(0x03A3 + x, a);
...
void game::SUB_004034() {
    ...
    L_0040BA:
        ...
        pushAddress(0x80C1);
        jump(0xFE95);
        if (handleReturnAddress(poppedEntry.value, 0x80C1)) return;
        a = myMapper->readCPU(0x0010);
        myMapper->writeCPU(0xBFFF, a);
        opLSR_A(1);
        myMapper->writeCPU(0xBFFF, a);
...
L_004342:
    ...
    pushAddress(0x8366);
    jump(0xFE95);
    if (handleReturnAddress(poppedEntry.value, 0x8366)) return;
    a = myMapper->readCPU(0x0010);
    myMapper->writeCPU(0xBFFF, a);
    opLSR_A(1);
    myMapper->writeCPU(0xBFFF, a);
...
void game::SUB_008036() {
    ...
    L_0080BC:
        ...
        pushAddress(0x80C3);
        jump(0xFE95);
        if (handleReturnAddress(poppedEntry.value, 0x80C3)) return;
        a = myMapper->readCPU(0x0010);
        myMapper->writeCPU(0xBFFF, a);
        opLSR_A(1);
        myMapper->writeCPU(0xBFFF, a);
...
L_00830C:
    ...
    pushAddress(0x8330);
    jump(0xFE95);
    if (handleReturnAddress(poppedEntry.value, 0x8330)) return;
    a = myMapper->readCPU(0x0010);
    myMapper->writeCPU(0xBFFF, a);
    opLSR_A(1);
    myMapper->writeCPU(0xBFFF, a);
...
void game::SUB_016B9D() {
    myMapper->writeCPU(0x2005, myMapper->readCPU(0x0091));
    myMapper->writeCPU(0x2005, 0x00);
    a = myMapper->readCPU(0x0040);
...
void game::SUB_01E0C9() {
    ...
    a = myMapper->readCPU(0x03A3);
    opCMP(a, myMapper->readCPU(0x0584));
    if (!flgZ) {
        if (flgN) {
            goto L_01E14C;
        }
    ...
    a = myMapper->readCPU(0x0385);
    if (a < myMapper->readCPU(0x0583)) {
    L_01E14C:
        myMapper->writeCPU(0x0385, myMapper->readCPU(0x0583));
        a = myMapper->readCPU(0x0584);
        myMapper->writeCPU(0x03A3, a);
    }
    else {
