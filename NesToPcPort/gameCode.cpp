...
//RAM
#define FRAME_COUNTER 0x03F
#define INPUT1        0x044
#define INPUT1_PRESS  0x045
#define INPUT2        0x046
#define INPUT2_PRESS  0x047
#define INPUT1_PREV   0x048
#define INPUT2_PREV   0x049
#define INPUTC        0x04B
#define INPUTC_PRESS  0x04C
#define INPUTC_PRESS_CPY 0x0B9


#define PLAYER_OFFSET  0x051 // Each player data takes 0x14 bytes

#define NUKE_COUNT1     0x052
#define NUKE_COUNT2     0x053
#define HEALTH1         0x054
#define HEALTH2         0x055
#define ARREST1         0x056
#define ARREST2         0x057
#define LIVES           0x058
#define LEVEL           0x059

#define NUKE_COUNT1_P2  0x066
#define NUKE_COUNT2_P2  0x067
#define HEALTH1_P2      0x068
#define HEALTH2_P2      0x069
#define ARREST1_P2      0x06A
#define ARREST2_P2      0x06B
#define LIVES_P2        0x06C
#define LEVEL_P2        0x06D

#define MUSIC_ENABLE    0x088
#define SOUND_ENABLE    0x089

#define OAMDATA_0   0x200
#define OAMDATA_1   0x201
#define OAMDATA_2   0x202
#define OAMDATA_3   0x203

#define PLAYER_POSITION_X1   0x385
#define PLAYER_POSITION_X2   0x3A3
#define PLAYER_POSITION_Y    0x3C1

#define NUKE_COUNT1_COPY     0x58F
#define NUKE_COUNT2_COPY     0x590
#define ARREST1_COPY         0x591
#define ARREST2_COPY         0x592

#define SCROLL_FINE  0x583
#define SCROLL_LARGE 0x584
#define TITLE_SCREEN_TIMER 0x597

#define MOVE_SPEED        0x5A3
#define PRESSED_DIRECTION 0x5CD

#define PALETTE_COPY    0x661
...
void game::SUB_000029() {
    ...
    L_000090:
        ...
        a = myMapper->readCPU(FRAME_COUNTER);
...
L_000154:
    ...
    myMapper->writeCPU(INPUTC_PRESS_CPY, a);
    myMapper->writeCPU(INPUTC_PRESS, a);
...
void game::SUB_00019F() {
    ...
    pushAddress(0x81A4);
    SUB_01DB37_ClearMetaTileHeaders();
    if (handleReturnAddress(poppedEntry.value, 0x81A4)) return;
    pushAddress(0x81A7);
    SUB_01DD59_ClearPalette();
    ...
    y = myMapper->readCPU(PLAYER_OFFSET);
    a = myMapper->readCPU(LEVEL + y);
    setLoadFlag(a);
    if (!flgZ) {
        y = 0x02;
...
void game::SUB_000223() {
    ...
    a = 0x00;
    myMapper->writeCPU(PRESSED_DIRECTION, a);
    myMapper->writeCPU(0x03FD, a);
...
void game::SUB_0002BB() {
    ...
    a = 0x00;
    myMapper->writeCPU(FRAME_COUNTER, a);
...
L_000308:
    ...
    waitScanline = 32;
	wait(3);
    a = myMapper->readCPU(INPUTC_PRESS_CPY);
    if (a == 0x10) {
        a = myMapper->readCPU(0x058C);
        setLoadFlag(a);
        if (!flgZ) {
...
void game::SUB_0003CF() {
    ...
    do {
        ...
        pushAddress(0x8414);
        SUB_01D60E_FillPPUWitjMetaTiles();
...
void game::SUB_0004D9_GameLogic01() {
    if (myMapper->readCPU(0x05D0) == 0) {
        goto L_0004F1;
    }
    if (myMapper->readCPU(0x0439) >= 0xC0) {
        x = 0x00;
        myMapper->writeCPU(MOVE_SPEED, x);
...
L_000756:
    ...
    if (flgZ) {
        ...
        if (!flgN) {
            x = a;
            opAND(0x3F);
            opORA(myMapper->readCPU(PRESSED_DIRECTION));
            myMapper->writeCPU(0x03FD, a);
            opDEC(0x05CE, 1);
            if (flgN) {
                goto L_000785;
    ...
    if (!flgZ) {
        ...
        if (flgZ) {
            ...
            if (flgN) {
                ...
                myMapper->writeCPU(0x0000, myMapper->readCPU(MOVE_SPEED));
                a = myMapper->readCPU(0x05A4);
            }
            opROL_M(0x0000, 1);
            opROL_A(1);
    ...
    if (!flgZ) {
        ...
        if (myMapper->readCPU(0x03FD + y) != 0xFF) {
            ...
            if (myMapper->readCPU(0x0529 + y) < 0x12) {
                ...
                a = myMapper->readCPU(PLAYER_POSITION_Y + y);
                flgC = false;
                opADC(0x20);
                flgC = true;
...
void game::SUB_0009B5() {
    ...
    opBIT(myMapper->readCPU(PRESSED_DIRECTION));
    if (flgN) {
        flgC = true;
        opSBC(0x10);
        myMapper->writeCPU(PLAYER_POSITION_X1 + y, a);
        a = myMapper->readCPU(PLAYER_POSITION_X2);
        opSBC(0x00);
        myMapper->writeCPU(PLAYER_POSITION_X2 + y, a);
        a = 0xFA;
...
L_0009F9:
    flgC = false;
    opADC(myMapper->readCPU(PLAYER_POSITION_Y));
    myMapper->writeCPU(PLAYER_POSITION_Y + y, a);
    myMapper->writeCPU(0x03FD + y, myMapper->readCPU(PRESSED_DIRECTION));
    a = 0x03;
...
void game::SUB_000A62() {
    ...
    y = myMapper->readCPU(PLAYER_POSITION_Y);
    flgC = true;
    a = myMapper->readCPU(PLAYER_POSITION_X1);
    opSBC(0x04);
    x = a;
...
void game::SUB_000B9C() {
    ...
    myMapper->writeCPU(0x0095, myMapper->readCPU(PLAYER_POSITION_X2 + x));
    y = myMapper->readCPU(PLAYER_POSITION_Y + x);
    a = myMapper->readCPU(PLAYER_POSITION_X1 + x);
    x = a;
    pushAddress(0x8BAF);
    jump(0xE567);
...
L_000BE0:
    ...
    if (a < 0x08) {
        ...
        a = myMapper->readCPU(PLAYER_POSITION_Y + x);
        opAND(0xF8);
        myMapper->writeCPU(PLAYER_POSITION_Y + x, a);
    }
    ...
    opDEY(1);
L_000C33:
    opADC(myMapper->readCPU(PLAYER_POSITION_X1 + x));
    myMapper->writeCPU(PLAYER_POSITION_X1 + x, a);
    a = y;
    opADC(myMapper->readCPU(PLAYER_POSITION_X2 + x));
    myMapper->writeCPU(PLAYER_POSITION_X2 + x, a);
    popAddress();
}
...
L_000C56:
    ...
    if (!flgN) {
        ...
        opSBC(0x10);
        myMapper->writeCPU(PLAYER_POSITION_X1 + y, a);
        a = myMapper->readCPU(PLAYER_POSITION_X2 + x);
        opSBC(0x00);
        myMapper->writeCPU(PLAYER_POSITION_X2 + y, a);
        a = myMapper->readCPU(PLAYER_POSITION_Y + x);
        flgC = false;
...
void game::SUB_000D87() {
    ...
    if (flgZ) {
        ...
        if (!flgN) {
            ...
            flgC = true;
            opSBC(myMapper->readCPU(PLAYER_POSITION_Y + x));
            ...
            if (flgZ) {
                ...
                myMapper->writeCPU(0x0000, myMapper->readCPU(PLAYER_POSITION_X2));
                a = myMapper->readCPU(PLAYER_POSITION_X1);
                flgC = false;
                opADC(0x08);
                if (flgC) {
                ...
                flgC = true;
                opSBC(myMapper->readCPU(PLAYER_POSITION_X1 + x));
                myMapper->writeCPU(0x0001, a);
                a = myMapper->readCPU(0x0000);
                opSBC(myMapper->readCPU(PLAYER_POSITION_X2 + x));
                if (flgZ) {
...
L_000E03:
    ...
    L_000E47:
        ...
        if (!flgN) {
            opADC(myMapper->readCPU(PLAYER_POSITION_Y + x));
            myMapper->writeCPU(PLAYER_POSITION_Y + x, a);
            if (!flgC) {
                goto L_000E71;
            }
    ...
    L_000E93:
        flgC = false;
        opADC(myMapper->readCPU(PLAYER_POSITION_X1));
        myMapper->writeCPU(PLAYER_POSITION_X1, a);
        a = y;
        opADC(myMapper->readCPU(PLAYER_POSITION_X2));
        myMapper->writeCPU(PLAYER_POSITION_X2, a);
    }
    popAddress();
}
...
L_000FED:
    if (myMapper->readCPU(0x0457 + x) == 0) {
        ...
        opADC(0x20);
        flgC = true;
        opSBC(myMapper->readCPU(PLAYER_POSITION_Y));
        if (!flgN) {
            if (a >= 0x3F) {
                goto L_00100A;
            }
...
L_0011E7:
    ...
    myMapper->writeCPU(PLAYER_POSITION_Y + y, myMapper->readCPU(PLAYER_POSITION_Y + x));
    a = 0x00;
    jump(0x968B);
    return;
L_001206:
...
void game::SUB_001508() {
    ...
    if (!flgZ) {
        ...
        if (myMapper->readCPU(0x03FD + y) != 0xFF) {
            ...
            opADC(0x08);
            flgC = true;
            opSBC(myMapper->readCPU(PLAYER_POSITION_Y + y));
            if (flgC) {
                ...
                opADC(0x08);
                flgC = true;
                opSBC(myMapper->readCPU(PLAYER_POSITION_X1 + y));
                myMapper->writeCPU(0x0000, a);
                a = myMapper->readCPU(0x0025);
                opSBC(myMapper->readCPU(PLAYER_POSITION_X2 + y));
                if (flgZ) {
...
L_001593:
    ...
    y = myMapper->readCPU(PLAYER_OFFSET);
    if (myMapper->readCPU(LEVEL + y) != 0x05) {
        goto L_0015B8;
    }
...
void game::SUB_001606() {
    ...
    if (flgZ) {
        ...
        opBIT(myMapper->readCPU(FRAME_COUNTER));
        if (flgN) {
            myMapper->writeCPU(0x0565 + x, 0x20);
        }
        y = 0x18;
...
void game::SUB_00168B() {
    ...
    myMapper->writeCPU(0x0457 + y, a);
    myMapper->writeCPU(0x03DF + y, a);
    myMapper->writeCPU(0x0000, myMapper->readCPU(PLAYER_POSITION_X1 + x));
    myMapper->writeCPU(0x0001, myMapper->readCPU(PLAYER_POSITION_X2 + x));
...
void game::SUB_0017FC() {
    ...
    myMapper->writeCPU(PLAYER_POSITION_X1 + x, myMapper->readCPU(SCROLL_FINE));
    a = myMapper->readCPU(SCROLL_LARGE);
    flgC = false;
    opADC(0x01);
    myMapper->writeCPU(PLAYER_POSITION_X2 + x, a);
    opINY(1);
    myMapper->writeCPU(PLAYER_POSITION_Y + x, myMapper->readCPU(myMapper->readCPU(0x000E) + (myMapper->readCPU((0x000E + 1) & 0x00ff) << 8) + y));
    a = 0x00;
...
L_001BC0:
    myMapper->writeCPU(0x0025, myMapper->readCPU(PLAYER_POSITION_X2 + x));
    a = myMapper->readCPU(PLAYER_POSITION_X1 + x);
    flgC = false;
...
L_001BD0:
    flgC = true;
    opSBC(myMapper->readCPU(PLAYER_POSITION_X1));
    myMapper->writeCPU(0x0024, a);
    a = myMapper->readCPU(0x0025);
    opSBC(myMapper->readCPU(PLAYER_POSITION_X2));
    if (!flgZ) {
        jump(0x9BE7);
        return;
    }
...
L_004342:
    ...
    if (flgZ) {
        ...
        myMapper->writeCPU(PLAYER_POSITION_X1 + x, myMapper->readCPU(PLAYER_POSITION_X1));
        a = myMapper->readCPU(PLAYER_POSITION_X2);
        myMapper->writeCPU(PLAYER_POSITION_X2 + x, a);
    L_0043CA:
        pushAddress(0x83CC);
...
void game::SUB_004540_GameLogic02() {
    y = myMapper->readCPU(PLAYER_OFFSET);
    if (myMapper->readCPU(LEVEL + y) == 0x04) {
        a = myMapper->readCPU(PLAYER_POSITION_X1);
        opORA(myMapper->readCPU(PLAYER_POSITION_X2));
        if (flgZ) {
            if (myMapper->readCPU(0x05C3) < 0x10) {
                goto L_004564;
            }
            myMapper->writeCPU(LEVEL + y, myMapper->readCPU(0x058E));
            a = 0xFE;
            myMapper->writeCPU(0x05D1, a);
            popAddress();
            return;
...
L_004564:
    if (myMapper->readCPU(0x05D0) != 0) {
        ...
        myMapper->writeCPU(MOVE_SPEED, x);
        myMapper->writeCPU(0x05A4, x);
        x = myMapper->readCPU(PLAYER_OFFSET);
        if (myMapper->readCPU((LEVEL + x) & 0x00ff) == 0x07) {
...
void game::SUB_004FD8() {
    ...
    myMapper->writeCPU(0x04ED + x, 0xFF);
    opINC(0x0475 + x, 1);
    SUB_004FED_Hovercraft();
    return;
}

void game::SUB_004FED_Hovercraft() {
    a = 0x00;
    myMapper->writeCPU(0x0486, a);
    pushAddress(0x8FF4);
    jump(0x8EF3);
...
L_00501C:
    ...
    if (flgN) {
        ...
        y = myMapper->readCPU(PLAYER_POSITION_X2);
        if (y != 0x03) {
            goto L_00505B;
        }
        y = myMapper->readCPU(PLAYER_POSITION_X1);
        if (y < 0xE0) {
            goto L_00505B;
        }
        if (a >= 0x21) {
...
L_00505B:
    ...
    y = 0x11;
    myMapper->writeCPU(PLAYER_POSITION_X1 + y, myMapper->readCPU(PLAYER_POSITION_X1 + x));
    myMapper->writeCPU(PLAYER_POSITION_X2 + y, myMapper->readCPU(PLAYER_POSITION_X2 + x));
    a = myMapper->readCPU(PLAYER_POSITION_Y + x);
    flgC = false;
    opADC(0x10);
    myMapper->writeCPU(PLAYER_POSITION_Y + y, a);
...
void game::SUB_005104() {
    ...
    return;
L_00510A:
    myMapper->writeCPU(PLAYER_POSITION_X1, myMapper->readCPU(PLAYER_POSITION_X1 + x));
    myMapper->writeCPU(PLAYER_POSITION_X2, myMapper->readCPU(PLAYER_POSITION_X2 + x));
...
void game::SUB_00513D() {
    a = myMapper->readCPU(PLAYER_POSITION_Y + x);
    opORA(myMapper->readCPU(PLAYER_POSITION_X1 + x));
    opAND(0x07);
    if (flgZ) {
        pushAddress(0x9149);
        jump(0x90AE);
...
void game::SUB_005207() {
    ...
    myMapper->writeCPU(0x041B + x, 0x02);
    myMapper->writeCPU(0x04ED + x, 0xFF);
    myMapper->writeCPU(PLAYER_POSITION_Y + x, myMapper->readCPU(0x04CF + x));
L_005223:
    a = 0x1E;
    pushAddress(0x9227);
    jump(0xEA16);
...
void game::SUB_005294() {
    myMapper->writeCPU(0x03FD + x, 0x00);
    if (myMapper->readCPU(PLAYER_POSITION_Y + x) >= myMapper->readCPU(0x04CF + x)) {
        goto L_005311;
    }
    myMapper->writeCPU(0x041B + x, 0x04);
    myMapper->writeCPU(0x04ED + x, 0xFF);
    ...
    myMapper->writeCPU(0x05A4, a);
    myMapper->writeCPU(0x05AA, a);
    myMapper->writeCPU(MOVE_SPEED, 0x00);
    opINC(PLAYER_POSITION_Y + x, 1);
    a = myMapper->readCPU(PLAYER_POSITION_Y + x);
    flgC = false;
    opADC(0x0F);
    myMapper->writeCPU(PLAYER_POSITION_Y, a);
...
void game::SUB_005629() {
    ...
    L_005680:
        ...
        myMapper->writeCPU(0x03DF + x, a);
    L_005694:
        a = myMapper->readCPU(PLAYER_POSITION_X1 + y);
        flgC = false;
        opADC(0x08);
        myMapper->writeCPU(PLAYER_POSITION_X1 + x, a);
        a = myMapper->readCPU(PLAYER_POSITION_X2 + y);
        opADC(0x00);
        myMapper->writeCPU(PLAYER_POSITION_X2 + x, a);
    }
    a = myMapper->readCPU(0x04ED + x);
...
void game::SUB_005793() {
    a = 0x60;
    opCMP(a, myMapper->readCPU(PLAYER_POSITION_X1));
    if (!flgZ) {
        if (!flgN) {
            goto L_0057A7;
        }
...
void game::SUB_005FCD() {
    ...
    L_005FE3:
        y = 0x03;
        x = myMapper->readCPU(PLAYER_OFFSET);
        if (myMapper->readCPU((LEVEL + x) & 0x00ff) != 0x01) {
            y = 0x0B;
        }
        a = myMapper->readCPU(0x00A0);
        x = 0x03;
...
void game::SUB_0084CE_GameLogic03() {
    if (myMapper->readCPU(0x05D0) == 0) {
        goto L_0084F3;
    }
    if (myMapper->readCPU(0x0439) >= 0xC0) {
...
void game::SUB_009A10() {
    ...
    if (flgV) {
        ...
        y = 0x03;
        x = myMapper->readCPU(PLAYER_OFFSET);
        a = myMapper->readCPU((LEVEL + x) & 0x00ff);
        if (a != 0x08) {
            y = 0x0B;
            if (a != 0x09) {
                goto L_009A41;
...
void game::SUB_00C44F_GameLogic04() {
    if (myMapper->readCPU(0x05D0) == 0) {
        goto L_00C474;
    }
    if (myMapper->readCPU(0x0439) >= 0xC0) {
...
void game::SUB_00CBF3() {
    ...
    if (flgZ) {
        opINC(PLAYER_POSITION_Y + x, 1);
        if (myMapper->readCPU(PLAYER_POSITION_Y + x) >= 0xE8) {
            goto L_00CC4F;
        }
    }
    a = myMapper->readCPU(FRAME_COUNTER);
...
L_00D603:
    ...
    if (a == myMapper->readCPU(0x05B0)) {
        ...
        opADC(0x01);
        opASL_A(5);
        if (a < myMapper->readCPU(PLAYER_POSITION_Y)) {
            a = myMapper->readCPU(FRAME_COUNTER);
            opAND(0x07);
            if (flgZ) {
                opDEC(0x008E, 1);
...
void game::SUB_0154D4() {
    myMapper->writeCPU(OAMDATA_3, 0x01);
    myMapper->writeCPU(OAMDATA_0, 0xBE);
    myMapper->writeCPU(OAMDATA_1, 0xFF);
    myMapper->writeCPU(OAMDATA_2, 0x00);
    ...
    myMapper->writeCPU(PLAYER_POSITION_X1, 0x80);
    myMapper->writeCPU(PLAYER_POSITION_Y, 0x70);
...
void game::SUB_0155A0() {
    x = myMapper->readCPU(INPUTC_PRESS);
    if (x != 0x10) {
        goto L_0155B9;
    }
    a = myMapper->readCPU(0x058C);
...
void game::SUB_0155C5_ShootingGalleryMain() {
    do {
        do {
            pushAddress(0x95C7);
            jump(0xDBB3);
...
void game::SUB_015646() {
    ...
    do {
        myMapper->writeCPU(0x0475 + x, 0x01);
        myMapper->writeCPU(PLAYER_POSITION_X1 + x, 0x10);
        a = 0x00;
        myMapper->writeCPU(PLAYER_POSITION_X2 + x, a);
        myMapper->writeCPU(0x03DF + x, a);
        myMapper->writeCPU(0x041B + x, 0x06);
...
void game::SUB_015815_ShootingGallery1() {
    ...
    if (!flgZ) {
        ...
        if (myMapper->readCPU(0x00D6) == 0) {
            ...
            myMapper->writeCPU(0x00D4, a);
            pushAddress(0x987F);
            jump(0x99C2); //Convert Aim to tile offset
...
void game::SUB_0158F7_ShootingGallery2() {
    x = 0x00;
    if (myMapper->readCPU(0x00D1) & 0x80) {
        x = 0xFF;
    }
 ...
 //   Uint16 mx = myConsole->controllers.getMouseX() * 2;
	//a = mx & 0xFF;
 //   myMapper->writeCPU(PLAYER_POSITION_X1, a);
 //   a = myMapper->readCPU(PLAYER_POSITION_X2);
...
//            goto L_015930;
//        }
//        if (myMapper->readCPU(PLAYER_POSITION_X1) >= 0x08) {
//            goto L_015930;
//        }
//    }
//    myMapper->writeCPU(PLAYER_POSITION_X1, 0x08);
//    myMapper->writeCPU(PLAYER_POSITION_X2, 0x00);
//    a = 0x00;
//    myMapper->writeCPU(0x00D0, a);
//    myMapper->writeCPU(0x00D1, a);
//    goto L_015952;
...
//            goto L_015942;
//        }
//        if (myMapper->readCPU(PLAYER_POSITION_X1) < 0xE8) {
//            goto L_015952;
//        }
//    L_015942:
//        myMapper->writeCPU(PLAYER_POSITION_X1, 0xE8);
//        myMapper->writeCPU(PLAYER_POSITION_X2, 0x01);
//        a = 0x00;
//        myMapper->writeCPU(0x00D0, a);
//        myMapper->writeCPU(0x00D1, a);
//    }
...
L_015952:
    ...
    a = myConsole->controllers.getMouseY();
    myMapper->writeCPU(PLAYER_POSITION_Y, a);
    opCMP(a, 0x10);
    if (!flgC) {
        myMapper->writeCPU(PLAYER_POSITION_Y, 0x10);
        a = 0x00;
        myMapper->writeCPU(0x00D2, a);
        myMapper->writeCPU(0x00D3, a);
    }
        ...
        myMapper->writeCPU(PLAYER_POSITION_Y, 0xA8);
        a = 0x00;
        myMapper->writeCPU(0x00D2, a);
        myMapper->writeCPU(0x00D3, a);
    }
...
void game::SUB_01597D_ShootingGalleryAimToScroll() {
//    a = myMapper->readCPU(PLAYER_POSITION_X1);
//    flgC = true;
//    opSBC(0x7F);
//    myMapper->writeCPU(SCROLL_FINE, a);
...
//L_0159A7:
    myMapper->writeCPU(SCROLL_FINE, (myMapper->readCPU(PLAYER_POSITION_X1) >> 1) | (myMapper->readCPU(PLAYER_POSITION_X2) << 7));
    myMapper->writeCPU(SCROLL_LARGE, 0x00);
    popAddress();
}

void game::SUB_0159A8_ShootingGallerySetScreenScroll() {
...
void game::SUB_0159C2_ShootGalleryConvertAimToTileOffset() {
	//divide player position by 8 to get tile position
	//combine X and Y to 2 bytes and look up in table
    a = myMapper->readCPU(PLAYER_POSITION_Y);
    flgC = false;
    opADC(0x0C);
    opLSR_A(3);
    ...
    while (true) {
        ...
        if (!flgZ) {
            ...
            if (!flgZ) {
                ...
                opROL_M(0x0001, 1);
                myMapper->writeCPU(PLAYER_POSITION_X1 + x, a);
                myMapper->writeCPU(PLAYER_POSITION_X2 + x, myMapper->readCPU(0x0001));
...
L_015BDC:
    ...
    myMapper->writeCPU(0x0002, a);
    myMapper->writeCPU(0x00DD, myMapper->readCPU(PLAYER_POSITION_Y + x));
    y = myMapper->readCPU(0x04ED + x);
    a = myMapper->readCPU(0xA001 + y);
    ...
    while (true) {
        do {
            ...
            myMapper->writeCPU(PLAYER_POSITION_X1 + x, myMapper->readCPU(0x00DB));
            myMapper->writeCPU(PLAYER_POSITION_X2 + x, myMapper->readCPU(0x00DC));
            myMapper->writeCPU(PLAYER_POSITION_Y + x, myMapper->readCPU(0x00DD));
            myMapper->writeCPU(0x03DF + x, 0x00);
...
void game::SUB_0164D5() {
    myMapper->writeCPU(OAMDATA_3, 0x00);
    myMapper->writeCPU(OAMDATA_0, 0xAF);
    myMapper->writeCPU(OAMDATA_1, 0xFF);
    myMapper->writeCPU(OAMDATA_2, 0x00);
    a = 0x00;
    myMapper->writeCPU(0x05BD, a);
    ...
    myMapper->writeCPU(PLAYER_POSITION_X1, 0x30);
    myMapper->writeCPU(PLAYER_POSITION_X2, 0x00);
    myMapper->writeCPU(PLAYER_POSITION_Y, 0x80);
    myMapper->writeCPU(0x03DF, 0x00);
...
void game::SUB_0165ED() {
    while (true) {
        ...
        setLoadFlag(a);
        if (!flgZ) {
            opCMP(myMapper->readCPU(INPUTC_PRESS), 0x10);
            if (!flgZ) {
                goto L_016622;
            }
            a = 0xFF;
...
void game::SUB_01686A_GameLogic05() {
...
L_016B37:
    ...
    flgC = true;
    opSBC(0x10);
    if (a >= myMapper->readCPU(PLAYER_POSITION_X1)) {
        goto L_016B9C;
    }
    myMapper->writeCPU(PLAYER_POSITION_X1, a);
    a = 0x01;
...
void game::SUB_0174D2() {
    myMapper->writeCPU(PLAYER_POSITION_X1, 0x58);
    myMapper->writeCPU(PLAYER_POSITION_Y, 0x78);
    myMapper->writeCPU(0x00EB, 0x05);
    myMapper->writeCPU(0x00EA, 0x09);
    a = 0x00;
    myMapper->writeCPU(0x065C, a);
...
void game::SUB_0175A6() {
    ...
    while (true) {
        ...
        opINC(0x00CD, 1);
        y = myMapper->readCPU(PLAYER_OFFSET);
        if (myMapper->readCPU(LEVEL + y) == 0x14) {
            goto L_0175DD;
        }
...
void game::SUB_0177D6() {
    ...
    myMapper->writeCPU(0x0480, a);
    do {
        myMapper->writeCPU(OAMDATA_1 + y, myMapper->readCPU(0xB846 + x));
        myMapper->writeCPU(OAMDATA_3 + y, myMapper->readCPU(0x0391));
        myMapper->writeCPU(OAMDATA_0 + y, myMapper->readCPU(0x03CD));
        myMapper->writeCPU(OAMDATA_2 + y, 0x00);
        a = y;
        flgC = false;
        opADC(0x04);
        y = a;
...
void game::SUB_019D79() {
    ...
    do {
		...
		//press start to skip briefing before hand spike animation
        a = myMapper->readCPU(INPUTC_PRESS);
        opAND(0x10);
        if (!flgZ) {
            goto L_019D94;
...
void game::SUB_019E2D() {
    ...
    myMapper->writeCPU(0x0480, a);
    do {
        myMapper->writeCPU(OAMDATA_1 + y, myMapper->readCPU(0x9EA3 + x));
        myMapper->writeCPU(OAMDATA_3 + y, myMapper->readCPU(0x0391));
        myMapper->writeCPU(OAMDATA_0 + y, myMapper->readCPU(0x03CD));
        myMapper->writeCPU(OAMDATA_2 + y, 0x00);
        a = y;
...
void game::SUB_019F13() {
    ...
    do {
        ...
        setLoadFlag(a);
        if (!flgZ) {
            myMapper->writeCPU(OAMDATA_1 + y, a);
            myMapper->writeCPU(OAMDATA_3 + y, myMapper->readCPU(0x0391));
            myMapper->writeCPU(OAMDATA_0 + y, myMapper->readCPU(0x03CD));
            myMapper->writeCPU(OAMDATA_2 + y, 0x00);
            a = y;
...
void game::SUB_01A073() {
    ...
    myMapper->writeCPU(PLAYER_POSITION_X1, 0x0F);
    myMapper->writeCPU(PLAYER_POSITION_Y, 0x04);
    ...
    while (true) {
        while (true) {
            while (true) {
                ...
                //press start to skip briefing as message
                a = myMapper->readCPU(INPUTC_PRESS);
                opAND(0x10);
                if (!flgZ) {
                    goto L_01A0FD;
    ...
    L_01A101:
        ...
        x = myMapper->readCPU(PLAYER_POSITION_Y);
        y = 0x20;
        pushAddress(0xA10B);
        SUB_01DCB2_Multiply();
...
void game::SUB_01B005_InputName() {
    a = 0x00;
...
void game::SUB_01B031_HighScoreScreen() {
...
void game::SUB_01B119() {
    myMapper->writeCPU(PLAYER_POSITION_Y, 0xA0);
    a = myMapper->readCPU(0x052A);
    opASL_A(3);
    flgC = false;
    opADC(0x15);
...
void game::SUB_01B1AC() {
    ...
    flgC = false;
    opADC(0x31);
    x = myMapper->readCPU(PLAYER_POSITION_X1);
    y = myMapper->readCPU(PLAYER_POSITION_Y);
    pushAddress(0xB1BD);
    jump(0xB263);
...
void game::SUB_01B32C() {
    ...
    y = myMapper->readCPU(PLAYER_OFFSET);
    x = myMapper->readCPU((LEVEL + y) & 0x00ff);
    myMapper->writeCPU(0x007C, myMapper->readCPU(0xC280 + x));
    myMapper->writeCPU(0x007D, myMapper->readCPU(0xC29E + x));

	//convert nuke digit 2 and 1 to single byte and store in $00A8
    a = 0x00;
    x = myMapper->readCPU((NUKE_COUNT2 + y) & 0x00ff);
    setLoadFlag(x);
    if (!flgZ) {
        do {
            flgC = false;
    ...
    flgC = false;
    opADC(myMapper->readCPU(NUKE_COUNT1 + y));
    myMapper->writeCPU(0x00A8, a);

	//convert arrest digit 2 and 1 to single byte and store in $00A9
    a = 0x00;
    x = myMapper->readCPU((ARREST2 + y) & 0x00ff);
    setLoadFlag(x);
    if (flgZ) {
        goto L_01B361;
    }
...
L_01B361:
    flgC = false;
    opADC(myMapper->readCPU(ARREST1 + y));
    myMapper->writeCPU(0x00A9, a);


    a = 0x00;
    myMapper->writeCPU(NUKE_COUNT1 + y, a);
    myMapper->writeCPU(NUKE_COUNT2 + y, a);
    myMapper->writeCPU(ARREST1 + y, a);
    myMapper->writeCPU(ARREST2 + y, a);
    myMapper->writeCPU(0x0005, 0x11);
    a = 0x90;
    myMapper->writeCPU(0x0006, a);
    x = 0x00;
...
void game::SUB_01B425() {
    ...
    while (true) {
        ...
        //Press start to skip intermission, counting nuke
        a = myMapper->readCPU(INPUTC_PRESS);
        opAND(0x10);
        if (flgZ) {
            goto L_01B488;
...
L_01B4D7:
    ...
    while (true) {
        ...
        //Press start to skip intermission counting arrested
        a = myMapper->readCPU(INPUTC_PRESS);
        opAND(0x10);
        if (flgZ) {
            goto L_01B4EA;
...
void game::SUB_01B53A() {
    ...
    x = 0x00;
    do {
        myMapper->writeCPU(OAMDATA_1 + y, myMapper->readCPU(0xB59D + x));
        myMapper->writeCPU(OAMDATA_3 + y, myMapper->readCPU(0x0391));
        myMapper->writeCPU(OAMDATA_0 + y, myMapper->readCPU(0x03CD));
        myMapper->writeCPU(OAMDATA_2 + y, 0x00);
        a = y;
...
void game::SUB_01B5A3() {
    ...
    myMapper->writeCPU(0x0480, a);
    do {
        myMapper->writeCPU(OAMDATA_1 + y, myMapper->readCPU(0xB613 + x));
        myMapper->writeCPU(OAMDATA_3 + y, myMapper->readCPU(0x0391));
        myMapper->writeCPU(OAMDATA_0 + y, myMapper->readCPU(0x03CD));
        myMapper->writeCPU(OAMDATA_2 + y, 0x00);
        a = y;
...
void game::SUB_01B68B() {
    ...
    if (myMapper->readCPU(PLAYER_OFFSET) == 0) {
        goto L_01B6BA;
    }
...
L_01B6BA:
    ...
    do {
        do {
            ...
            //Press start to exit game over screen
            a = myMapper->readCPU(INPUTC_PRESS);
            opAND(0x10);
            if (!flgZ) {
                goto L_01B6FF;
...
void game::SUB_01B70F() {
    ...
    myMapper->writeCPU(PLAYER_POSITION_X1, 0xC0);
    myMapper->writeCPU(PLAYER_POSITION_Y, 0xA7);
...
void game::SUB_01C000_StartGame() {
    ...
    do {
        ...
        myMapper->writeCPU(0x0100 + x, a);
        myMapper->writeCPU(OAMDATA_0 + x, a);
...
void game::SUB_01C060_CopyNukeAndArrest() {
    myMapper->writeCPU(NUKE_COUNT1_COPY, myMapper->readCPU((NUKE_COUNT1 + x) & 0x00ff));
    myMapper->writeCPU(NUKE_COUNT2_COPY, myMapper->readCPU((NUKE_COUNT2 + x) & 0x00ff));
    myMapper->writeCPU(ARREST1_COPY, myMapper->readCPU((ARREST1 + x) & 0x00ff));
    myMapper->writeCPU(ARREST2_COPY, myMapper->readCPU((ARREST2 + x) & 0x00ff));
    popAddress();
}
...
void game::SUB_01C075() {
    do {
        x = 0x00;
        myMapper->writeCPU(PLAYER_OFFSET, x);
        myMapper->writeCPU(0x0595, 0x00);
...
void game::SUB_01C0B6() {
    x = myMapper->readCPU(PLAYER_OFFSET);
    a = myMapper->readCPU((LIVES + x) & 0x00ff);
    setLoadFlag(a);
    if (!flgZ) {
        goto L_01C0C0;
    }
...
L_01C0C0:
    x = myMapper->readCPU(PLAYER_OFFSET);
    pushAddress(0xC0C4);
    SUB_01C060_CopyNukeAndArrest();
    if (handleReturnAddress(poppedEntry.value, 0xC0C4)) return;
    while (true) {
        y = myMapper->readCPU((LEVEL + x) & 0x00ff);
    ...
    L_01C112:
        ...
        if (myMapper->readCPU(0x05AC) != 0xFE) {
            ...
            a = myMapper->readCPU(0x05AC);
            if (a != 0xFF) {
                myMapper->writeCPU((NUKE_COUNT1 + x) & 0x00ff, myMapper->readCPU(NUKE_COUNT1_COPY));
                myMapper->writeCPU((NUKE_COUNT2 + x) & 0x00ff, myMapper->readCPU(NUKE_COUNT2_COPY));
                myMapper->writeCPU((ARREST1 + x) & 0x00ff, myMapper->readCPU(ARREST1_COPY));
                myMapper->writeCPU((ARREST2 + x) & 0x00ff, myMapper->readCPU(ARREST2_COPY));
                myMapper->writeCPU((HEALTH2 + x) & 0x00ff, 0x02);
                a = 0x00;
                myMapper->writeCPU((HEALTH1 + x) & 0x00ff, a);
                myMapper->writeCPU(0x008E, a);
                opDEC((LIVES + x) & 0x00ff, 1);
                if (flgZ) {
                    a = myMapper->readCPU(0x059C);
                    setLoadFlag(a);
                    if (flgZ) {
        ...
        L_01C19A:
            x = myMapper->readCPU(PLAYER_OFFSET);
            opINC((LEVEL + x) & 0x00ff, 1);
            if (myMapper->readCPU((LEVEL + x) & 0x00ff) == 0x0E) {
                goto L_01C1A9;
            }
        ...
        L_01C1A9:
            a = 0x00;
            myMapper->writeCPU((LIVES + x) & 0x00ff, a);
            myMapper->writeCPU(0x05AC, a);
            pushAddress(0xC1B2);
            jump(0xF847);
...
L_01C1BD:
    ...
    myMapper->writeCPU((LEVEL + x) & 0x00ff, a);
    x = a;
...
void game::SUB_01CA70() {
    ...
    L_01CA9E:
        ...
        return;
    L_01CA9F:
        myMapper->writeCPU(0x0026, myMapper->readCPU(PLAYER_POSITION_Y + y));
...
void game::SUB_01CAC6() {
    ...
    if (!flgZ) {
        ...
        myMapper->writeCPU(OAMDATA_3 + x, a);
    ...
    myMapper->writeCPU(OAMDATA_1 + x, myMapper->readCPU(myMapper->readCPU(0x0005) + (myMapper->readCPU((0x0005 + 1) & 0x00ff) << 8) + y));
    opINY(1);
    myMapper->writeCPU(OAMDATA_2 + x, myMapper->readCPU(myMapper->readCPU(0x0005) + (myMapper->readCPU((0x0005 + 1) & 0x00ff) << 8) + y));
    opINY(1);
...
L_01CB6D:
    ...
    a = myMapper->readCPU(myMapper->readCPU(0x0005) + (myMapper->readCPU((0x0005 + 1) & 0x00ff) << 8) + y);
    opORA(0x40);
    myMapper->writeCPU(OAMDATA_2 + x, a);
    opINY(1);
    myMapper->writeCPU(0x020D + x, myMapper->readCPU(myMapper->readCPU(0x0005) + (myMapper->readCPU((0x0005 + 1) & 0x00ff) << 8) + y));
    opINY(1);
    a = myMapper->readCPU(myMapper->readCPU(0x0005) + (myMapper->readCPU((0x0005 + 1) & 0x00ff) << 8) + y);
...
L_01CDF8:
    myMapper->writeCPU(0x0028, a);
    myMapper->writeCPU(OAMDATA_0 + x, myMapper->readCPU(0x0026));
    a = myMapper->readCPU(0x0024);
    myMapper->writeCPU(OAMDATA_3 + x, a);
    y = 0x00;
    opBIT(myMapper->readCPU(0x0002));
...
void game::SUB_01CE23() {
    ...
    myMapper->writeCPU(OAMDATA_1 + x, myMapper->readCPU(myMapper->readCPU(0x0005) + (myMapper->readCPU((0x0005 + 1) & 0x00ff) << 8) + y));
    myMapper->writeCPU(OAMDATA_2 + x, myMapper->readCPU(myMapper->readCPU(0x0007) + (myMapper->readCPU((0x0007 + 1) & 0x00ff) << 8) + y));
    opINY(1);
    myMapper->writeCPU(0x0205 + x, myMapper->readCPU(myMapper->readCPU(0x0005) + (myMapper->readCPU((0x0005 + 1) & 0x00ff) << 8) + y));
...
void game::SUB_01CFB3() {
    ...
    if (!flgZ) {
        ...
        if (myMapper->readCPU(0x0032) == 0) {
            ...
            setLoadFlag(a);
            if (!flgZ) {
                myMapper->writeCPU(OAMDATA_1 + x, a);
                myMapper->writeCPU(OAMDATA_0 + x, myMapper->readCPU(0x0033));
                a = myMapper->readCPU(myMapper->readCPU(0x0007) + (myMapper->readCPU((0x0007 + 1) & 0x00ff) << 8) + y);
        ...
        if (myMapper->readCPU(0x0034) == 0) {
            ...
            if (!flgZ) {
                myMapper->writeCPU(OAMDATA_1 + x, a);
                myMapper->writeCPU(OAMDATA_0 + x, myMapper->readCPU(0x0035));
                a = myMapper->readCPU(myMapper->readCPU(0x0007) + (myMapper->readCPU((0x0007 + 1) & 0x00ff) << 8) + y);
                opORA(myMapper->readCPU(0x003E));
                myMapper->writeCPU(OAMDATA_2 + x, a);
                opINX(4);
        ...
        if (myMapper->readCPU(0x0036) == 0) {
            ...
            if (!flgZ) {
                myMapper->writeCPU(OAMDATA_1 + x, a);
                myMapper->writeCPU(OAMDATA_0 + x, myMapper->readCPU(0x0037));
                a = myMapper->readCPU(myMapper->readCPU(0x0007) + (myMapper->readCPU((0x0007 + 1) & 0x00ff) << 8) + y);
                opORA(myMapper->readCPU(0x003E));
                myMapper->writeCPU(OAMDATA_2 + x, a);
                opINX(4);
        ...
        if (myMapper->readCPU(0x0038) == 0) {
            ...
            if (!flgZ) {
                myMapper->writeCPU(OAMDATA_1 + x, a);
                myMapper->writeCPU(OAMDATA_0 + x, myMapper->readCPU(0x0039));
                a = myMapper->readCPU(myMapper->readCPU(0x0007) + (myMapper->readCPU((0x0007 + 1) & 0x00ff) << 8) + y);
                opORA(myMapper->readCPU(0x003E));
                myMapper->writeCPU(OAMDATA_2 + x, a);
                opINX(4);
        ...
        if (myMapper->readCPU(0x003A) == 0) {
            ...
            if (!flgZ) {
                myMapper->writeCPU(OAMDATA_1 + x, a);
                myMapper->writeCPU(OAMDATA_0 + x, myMapper->readCPU(0x003B));
                a = myMapper->readCPU(myMapper->readCPU(0x0007) + (myMapper->readCPU((0x0007 + 1) & 0x00ff) << 8) + y);
                opORA(myMapper->readCPU(0x003E));
                myMapper->writeCPU(OAMDATA_2 + x, a);
                opINX(4);
        ...
        if (myMapper->readCPU(0x003C) == 0) {
            ...
            if (!flgZ) {
                myMapper->writeCPU(OAMDATA_1 + x, a);
                myMapper->writeCPU(OAMDATA_0 + x, myMapper->readCPU(0x003D));
                a = myMapper->readCPU(myMapper->readCPU(0x0007) + (myMapper->readCPU((0x0007 + 1) & 0x00ff) << 8) + y);
                opORA(myMapper->readCPU(0x003E));
                myMapper->writeCPU(OAMDATA_2 + x, a);
                opINX(4);
...
void game::SUB_01D60E_FillPPUWitjMetaTiles() {
...
void game::SUB_01DB37_ClearMetaTileHeaders() {
    a = 0xFF;
...
void game::SUB_01DBB3() {
    a = myMapper->readCPU(FRAME_COUNTER);
L_01DBB5:
    if (a == myMapper->readCPU(FRAME_COUNTER)) {
        wait(1);
        goto L_01DBB5;
    }
    popAddress();
...
void game::SUB_01DBBA_ReadInput() {
    y = 0x01;
...
void game::SUB_01DBEB_DetectButtonPress() {
    a = 0x00;
    myMapper->writeCPU(INPUT1_PRESS, a);
    myMapper->writeCPU(INPUT2_PRESS, a);
    myMapper->writeCPU(0x0001, myMapper->readCPU(INPUT1));
    myMapper->writeCPU(0x0002, myMapper->readCPU(INPUT2));
    x = 0x07;
    //do {
    //    opASL_M(0x0001, 1);
    //    if (flgC) {
    //        opASL_M(INPUT1_PREV, 1);
    //        if (!flgC) {
    //            a = myMapper->readCPU(INPUT1_PREV);
    //            opORA(0x01);
    //            myMapper->writeCPU(INPUT1_PREV, a);
    //            flgC = true;
    //            opROL_M(INPUT1_PRESS, 1);
    //            goto L_01DC23;
    //        }
    //        a = myMapper->readCPU(INPUT1_PREV);
    //        opORA(0x01);
    ...
    //    opASL_M(0x0002, 1);
    //    if (flgC) {
    //        opASL_M(INPUT2_PREV, 1);
    //        if (flgC) {
    //            goto L_01DC37;
    //        }
    //        a = myMapper->readCPU(INPUT2_PREV);
    //        opORA(0x01);
    //        myMapper->writeCPU(INPUT2_PREV, a);
    //        flgC = true;
    //        opROL_M(INPUT2_PRESS, 1);
    //        goto L_01DC4B;
    //    L_01DC37:
    //        a = myMapper->readCPU(INPUT2_PREV);
    //        opORA(0x01);
    ...
    a = myMapper->readCPU(PLAYER_OFFSET);
    setLoadFlag(a);
    if (!flgZ) {
        x = myMapper->readCPU(INPUT2);
        y = myMapper->readCPU(INPUT2_PRESS);
    }
    else {
        x = myMapper->readCPU(INPUT1);
        y = myMapper->readCPU(INPUT1_PRESS);
    }
    myMapper->writeCPU(INPUTC, x);
    myMapper->writeCPU(INPUTC_PRESS, y);
    y = myMapper->readCPU(INPUTC_PRESS);
    myMapper->writeCPU(INPUTC_PRESS_CPY, y);
    popAddress();
}
...
void game::SUB_01DD0B_CopyOneScreen() {
    a = myMapper->readCPU(PPU_STATUS);
...
void game::SUB_01DD26() {
    ...
    opBIT(myMapper->readCPU(PPU_STATUS));
    if (!flgN) wait(1);
    SUB_01DD2B_CopyPaletteIndirect();
    return;
}

void game::SUB_01DD2B_CopyPaletteIndirect() {
    a = myMapper->readCPU(PPU_STATUS);
...
void game::SUB_01DD59_ClearPalette() {
    //do {
    //    opBIT(myMapper->readCPU(PPU_STATUS));
    //} while (!flgN);
    opBIT(myMapper->readCPU(PPU_STATUS));
...
void game::SUB_01DD83_SetStatusBar() {
    a = myMapper->readCPU(PPU_STATUS);
	//clear 2 rows of nametable 2000
	...
	//copy 8 bytes to attribute table 23C0
    ...
    y = myMapper->readCPU(PLAYER_OFFSET);
    x = myMapper->readCPU((NUKE_COUNT1 + y) & 0x00ff);
    a = myMapper->readCPU(NUKE_COUNT2 + y);
    y = a;
    pushAddress(0xDDE0);
    jump(0xE81E);
    ...
    y = myMapper->readCPU(PLAYER_OFFSET);
    x = myMapper->readCPU((HEALTH1 + y) & 0x00ff);
    a = myMapper->readCPU(HEALTH2 + y);
    y = a;
    pushAddress(0xDDEE);
    jump(0xE7CA);
    ...
    y = myMapper->readCPU(PLAYER_OFFSET);
    x = myMapper->readCPU((ARREST1 + y) & 0x00ff);
    a = myMapper->readCPU(ARREST2);
    y = a;
    pushAddress(0xDDFB);
    jump(0xE877);
    ...
    y = myMapper->readCPU(PLAYER_OFFSET);
    myMapper->writeCPU(0x008D, myMapper->readCPU(LIVES + y));
    a = 0x00;
    myMapper->writeCPU(LIVES + y, a);
    popAddress();
}
...
void game::SUB_01DF13() {
    ...
    a = 0x0F;
    do {
        myMapper->writeCPU(PALETTE_COPY + y, a);
        opDEY(1);
    } while (!flgN);
    x = 0x01;
    pushAddress(0xDF24);
...
void game::SUB_01DFCE_CopyPaletteDirect() {
    if (!(myMapper->readCPU(PALETTE_COPY) & 0x80)) {
        goto L_01DFD4;
    }
    popAddress();
    return;
L_01DFD4:
    ...
    myMapper->writeCPU(PPU_ADDR, 0x00);
    myMapper->writeCPU(PPU_CTRL, myMapper->readCPU(0x0042));
    myMapper->writeCPU(PPU_DATA, myMapper->readCPU(PALETTE_COPY));
    ...
    myMapper->writeCPU(PPU_ADDR, a);
    myMapper->writeCPU(PPU_ADDR, a);
    myMapper->writeCPU(PALETTE_COPY, 0xFF);
    popAddress();
}
...
void game::SUB_01E0C9_ApplyWalkingSpeed() {
    a = myMapper->readCPU(0x05A4);
    setLoadFlag(a);
    if (!flgN) {
    ...
    L_01E0DE:
        ...
        opADC(myMapper->readCPU(MOVE_SPEED));
    ...
    L_01E14C:
        myMapper->writeCPU(PLAYER_POSITION_X1, myMapper->readCPU(SCROLL_FINE));
        a = myMapper->readCPU(SCROLL_LARGE);
        myMapper->writeCPU(PLAYER_POSITION_X2, a);
    }
    else {
...
void game::SUB_01E195_UpdateWalkingSpeed() {
    a = myMapper->readCPU(0x05CA);
    setLoadFlag(a);
    if (flgZ) {
        a = myMapper->readCPU(0x05C9);
...
L_01E7BC:
    ...
    a = y;
    y = myMapper->readCPU(PLAYER_OFFSET);
    myMapper->writeCPU(HEALTH2 + y, a);
    myMapper->writeCPU(HEALTH1 + y, x);
    y = myMapper->readCPU(0x0000);
    SUB_01E7CA();
    return;
}
...
void game::SUB_01E7DF() {
    ...
    do {
        ...
        L_01E7E8:
            y = myMapper->readCPU(PLAYER_OFFSET);
            x = myMapper->readCPU((NUKE_COUNT1 + y) & 0x00ff);
            y = myMapper->readCPU(NUKE_COUNT2 + y);
        ...
        opINC(0x0090, 1);
        a = x;
        opORA(myMapper->readCPU(NUKE_COUNT2));
    } while (flgZ);
    opDEX(1);
    if (flgN) {
        x = 0x09;
...
L_01E810:
    ...
    y = myMapper->readCPU(PLAYER_OFFSET);
    myMapper->writeCPU(NUKE_COUNT2 + y, a);
    myMapper->writeCPU(NUKE_COUNT1 + y, x);
    y = myMapper->readCPU(0x0001);
    SUB_01E81E();
    return;
}
...
void game::SUB_01E8D6() {
    y = myMapper->readCPU(PLAYER_OFFSET);
    x = myMapper->readCPU((LIVES + y) & 0x00ff);
    a = 0x20;
    myMapper->writeCPU(0x0187, a);
    myMapper->writeCPU(0x018B, a);
...
void game::SUB_01E92A() {
    ...
    setLoadFlag(a);
    if (!flgZ) {
        if (myMapper->readCPU(INPUT1) == 0x10) {
            goto L_01E955;
        }
...
void game::SUB_01E95B() {
    ...
    opAND(0x03);
    if (flgZ) {
        opDEC(TITLE_SCREEN_TIMER, 1);
        if (!flgZ) {
            flgC = false;
        }
        else {
            //timer reached zero, change demo level
            opINC(0x0598, 1);
            a = myMapper->readCPU(0x0598);
            if (a == 0x05) {
                //loop back to first demo level
                a = 0x01;
                myMapper->writeCPU(0x0598, a);
            }
            x = a;
            opDEX(1);
            myMapper->writeCPU(0x008C, myMapper->readCPU(LEVEL));
            myMapper->writeCPU(LEVEL, myMapper->readCPU(0xE992 + x));
...
void game::SUB_01E9E6() {
    ...
    if (flgZ) {
        ...
        x = myMapper->readCPU(MUSIC_ENABLE);
        setLoadFlag(x);
        if (flgZ) {
            goto L_01EA03;
        }
...
void game::SUB_01EA1B_SetupSound() {
    //save x and y
    myMapper->writeCPU(0x0000, x);
    myMapper->writeCPU(0x0001, y);
	//a is the sound index
    myMapper->writeCPU(0x00FD, a);
    if (myMapper->readCPU(SOUND_ENABLE) == 0) {
        goto L_01EA2F;
    }
    x = a;
    a = 0x04;
...
void game::SUB_01EA3E_RestoreBank012() {
...
void game::SUB_01EA98() {
    ...
    myMapper->writeCPU(OAMDATA_3, 0x10);
    myMapper->writeCPU(OAMDATA_0, 0x70);
    myMapper->writeCPU(OAMDATA_1, 0x01);
    a = 0x00;
    myMapper->writeCPU(OAMDATA_2, a);
    pushAddress(0xEAD7);
    SUB_01DD59_ClearPalette();
...
void game::SUB_01EC81() {
    ...
    do {
        ...
        if (!flgZ) {
            ...
            myMapper->writeCPU(OAMDATA_3 + y, myMapper->readCPU(0x0391));
            myMapper->writeCPU(OAMDATA_0 + y, myMapper->readCPU(0x03CD));
            myMapper->writeCPU(OAMDATA_2 + y, 0x02);
            a = y;
            flgC = false;
            opADC(0x04);
            y = a;
...
void game::SUB_01ED03() {
    ...
    while (y != 0xE4) {
        myMapper->writeCPU(OAMDATA_0 + y, 0xF0);
        a = y;
        flgC = false;
        opADC(0x04);
        y = a;
...
void game::SUB_01EDE5_MenuUpDown() {
    a = myMapper->readCPU(FRAME_COUNTER);
    opAND(0x07);
    if (flgZ) {
        opINC(0x03FD, 1);
    ...
    setLoadFlag(a);
    if (!flgZ) {
		//has input, reset title screen timer
        x = 0x00;
        myMapper->writeCPU(TITLE_SCREEN_TIMER, x);
    }
    opAND(0x04);
    if (!flgZ) {
        //pressed down
    ...
    opASL_A(1);
    x = a;
    myMapper->writeCPU(PLAYER_POSITION_X1, myMapper->readCPU(0xEE8D + x));
...
void game::SUB_01EE3E_MenuSelected() {
    a = myMapper->readCPU(INPUT1_PRESS);
    opAND(0x10);
    if (!flgZ) {
        ...
        case 0x03:
            ...
            break;
        case 0x04:
            a = myMapper->readCPU(MUSIC_ENABLE);
            opEOR(0xFF);
            opAND(0x01);
            myMapper->writeCPU(MUSIC_ENABLE, a);
            a = 0x00;
            pushAddress(0xEE80);
            jump(0xE9E6);
            ...
            break;
        case 0x05:
            a = myMapper->readCPU(SOUND_ENABLE);
            opEOR(0xFF);
            opAND(0x01);
            myMapper->writeCPU(SOUND_ENABLE, a);
            flgC = false;
            break;
        }
    }
...
void game::SUB_01F036() {
    ...
    myMapper->writeCPU(0x0480, a);
    do {
        myMapper->writeCPU(OAMDATA_1 + y, myMapper->readCPU(0xF0B2 + x));
        myMapper->writeCPU(OAMDATA_3 + y, myMapper->readCPU(0x0391));
        myMapper->writeCPU(OAMDATA_0 + y, myMapper->readCPU(0x03CD));
        myMapper->writeCPU(OAMDATA_2 + y, 0x00);
        a = y;
...
void game::SUB_01F189() {
    ...
    myMapper->writeCPU(LEVEL, a);
    myMapper->writeCPU(0x0087, a);
    a = 0x00;
    myMapper->writeCPU(PLAYER_OFFSET, a);
    pushAddress(0xF1A8);
    jump(0xB2CD);
...
void game::SUB_01F23A_InitPlayerState() {
    a = 0x02;
    myMapper->writeCPU(HEALTH2, a);
    myMapper->writeCPU(HEALTH2_P2, a);
    a = 0x00;
    myMapper->writeCPU(HEALTH1, a);
    myMapper->writeCPU(HEALTH1_P2, a);
    x = 0x04;
    myMapper->writeCPU(LIVES, x);
...
L_01F250:
    a = 0x00;
    myMapper->writeCPU(ARREST1, a);
    myMapper->writeCPU(ARREST2, a);
    myMapper->writeCPU(ARREST1_P2, a);
    myMapper->writeCPU(ARREST2_P2, a);
    myMapper->writeCPU(NUKE_COUNT1, a);
    myMapper->writeCPU(NUKE_COUNT2, a);
    myMapper->writeCPU(NUKE_COUNT1_P2, a);
    myMapper->writeCPU(NUKE_COUNT2_P2, a);
...
void game::SUB_01F356() {
    ...
    myMapper->writeCPU(0x0391, a);
    myMapper->writeCPU(0x0001, a);
    myMapper->writeCPU(0x03CD, myMapper->readCPU(PLAYER_POSITION_Y));
    a = myMapper->readCPU(0x03FD);
    opASL_A(4);
    x = a;
    y = 0x00;
    ...
    do {
        myMapper->writeCPU(OAMDATA_1 + y, myMapper->readCPU(0xF3C2 + x));
        myMapper->writeCPU(OAMDATA_3 + y, myMapper->readCPU(0x0391));
        myMapper->writeCPU(OAMDATA_0 + y, myMapper->readCPU(0x03CD));
        myMapper->writeCPU(OAMDATA_2 + y, 0x00);
        a = y;
...
void game::SUB_01FE80_SetSprite0() {
    myMapper->writeCPU(OAMDATA_3, 0xFC);
    myMapper->writeCPU(OAMDATA_0, 0x1D);
    myMapper->writeCPU(OAMDATA_1, 0xFF);
    myMapper->writeCPU(OAMDATA_2, 0x00);
    popAddress();
}
...
void game::jump(Uint16 target) {
    ...
    case 0x01F218:
        ...
        break;
    case 0x0155C5:
        SUB_0155C5_ShootingGalleryMain();
        break;
    case 0x0159A8:
        SUB_0159A8_ShootingGallerySetScreenScroll();
        break;
    case 0x01DBE8:
        SUB_01DBE8();
        break;
    ...
    case 0x0155A0:
        ...
        break;
    case 0x015815:
        SUB_015815_ShootingGallery1();
        break;
    case 0x0158F7:
        SUB_0158F7_ShootingGallery2();
        break;
    case 0x015646:
        SUB_015646();
        break;
    ...
    case 0x015C95:
        ...
        break;
    case 0x01597D:
        SUB_01597D_ShootingGalleryAimToScroll();
        break;
    case 0x01CA17:
        SUB_01CA17();
        break;
    ...
    case 0x0157DD:
        ...
        break;
    case 0x0159C2:
        SUB_0159C2_ShootGalleryConvertAimToTileOffset();
        break;
    case 0x0157FA:
        SUB_0157FA();
        break;
