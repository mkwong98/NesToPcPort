    ...
    if (!flgZ) {
        ...
        if (!flgZ) {
            ...
            if (flgN) {
                ...
                x = 0xFF;
                while(mStack.size() > 0) mStack.pop();
                myMapper->writeCPU(0x0033, myMapper->readCPU(0x002E));
                threadSignal = 0x003A;
                return;
            }
...
void game::SUB_00103C() {
    ...
    y = 0x00;
    do {
        if (myMapper->readCPU(0x0083 + y) != 0) {
            goto L_00107B;
        }
...
void game::SUB_001179() {
    ...
    if (flgZ) {
        ...
        a = myMapper->readCPU(0x0025);
        opCMP(a, myMapper->readCPU(0x0027));
        if (flgZ) {
            goto L_0011B0;
        }
        if (!flgC) {
...
void game::SUB_0025D5() {
    ...
    if (a == 0xC0) {
        ...
        if (flgC) {
            ...
            y = 0x42;
            if (myMapper->readCPU(0x0301 + x) & 0x80) {
                goto L_00260B;
            }
            y = 0x44;
        L_00260B:
...
L_002E49:
    ...
    myMapper->writeCPU(0x0302 + x, 0x00);
    opPLA();
    opPLA();
    a = myMapper->readCPU(0x0307 + x);
    SUB_002779();
...
void game::SUB_002F46() {
    ...
    if (flgZ) {
        ...
        if (!flgZ) {
            ...
            if (!flgC) {
                a = myMapper->readCPU(0x0304 + x);
                if (a < myMapper->readCPU(0x0302 + x)) {
                    goto L_002F6E;
                }
                opDEC(0x0304 + x, 1);
            }
                ...
                a = myMapper->readCPU(0x0304 + x);
                if (a >= myMapper->readCPU(0x0303 + x)) {
                    goto L_002F6E;
                }
                opINC(0x0304 + x, 1);
            }
...
L_002FB6:
    ...
    do {
        ...
        opCMP(a, myMapper->readCPU(0x0010));
        if (flgC) {
            if (!flgZ) {
                goto L_002FD4;
            }
    ...
    L_002FDB:
        a = myMapper->readCPU(0x0304 + y);
        opCMP(a, myMapper->readCPU(0x0011));
        if (!flgZ) {
            if (flgC) {
                goto L_002FF2;
            }
...
void game::SUB_00372D() {
    ...
    if (myMapper->readCPU(0x0055) == 0) {
        a = myMapper->readCPU(0x0051);
        opCMP(a, myMapper->readCPU(0x0052));
        if (flgZ) {
            goto L_0037BF;
        }
        if (!flgC) {
...
void game::SUB_00485A() {
    ...
    L_004899:
        ...
        return;
    L_00489A:
        a = myMapper->readCPU(0x031C);
        opCMP(a, myMapper->readCPU(0x0490));
    } while (flgZ);
    if (!flgC) {
        goto L_0048A9;
    }
